...
MOTOR_STEPS_PER_REV = int(os.environ.get("MOTOR_STEPS_PER_REV", "200"))
MOTOR_FREQUENCY_HZ = float(os.environ.get("MOTOR_FREQUENCY_HZ", "100"))
MOTOR_HOLD_SEC = float(os.environ.get("MOTOR_HOLD_SEC", "3.0"))
